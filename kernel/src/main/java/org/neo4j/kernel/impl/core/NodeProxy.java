...
class NodeProxy implements Node
{
    ...
    {
        return nm.getNodeForProxy( this, null ).getDegree( nm );
    }
    
    @Override
    public int getDegree( RelationshipType type )
    {
        return nm.getNodeForProxy( this, null ).getDegree( nm, type );
    }
    
    @Override
    public int getDegree( Direction direction )
    {
        return nm.getNodeForProxy( this, null ).getDegree( nm, direction );
    }
    
    @Override
    public int getDegree( RelationshipType type, Direction direction )
    {
        return nm.getNodeForProxy( this, null ).getDegree( nm, type, direction );
    }
    
    @Override
    public Iterable<RelationshipType> getRelationshipTypes()
    {
        return nm.getNodeForProxy( this, null ).getRelationshipTypes( nm );
    }
