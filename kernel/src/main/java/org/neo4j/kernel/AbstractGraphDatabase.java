        ...
        implements GraphDatabaseService, GraphDatabaseSPI
{
    ...
    protected RelationshipProxy.RelationshipLookups createRelationshipLookups()
    {
        return new RelationshipProxy.RelationshipLookups()
        {
            ...
            @Override
            public RelationshipImpl lookupRelationship( long relationshipId, LockType lockType )
            {
                return nodeManager.getRelationshipForProxy( relationshipId, lockType );
            }
        };
    }
    ...
    protected NodeProxy.NodeLookup createNodeLookup()
    {
        return new NodeProxy.NodeLookup()
        {
            ...
            @Override
            public NodeImpl lookup( long nodeId, LockType lockType )
            {
                return nodeManager.getNodeForProxy( nodeId, lockType );
            }
        };
    }
